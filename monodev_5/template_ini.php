<?php
/*
* Template - MONO_DEV by (C) 2018-2022 POTI-kai POTI-board redevelopment team.  >> https://paintbbs.sakura.ne.jp/poti/
...
*/
//テーマ(テンプレート)のバージョン
define('TEMPLATE_VER', "v5.00.0 lot.220330.0");
...
//メインのテンプレートファイル
define('MAINFILE', "monoev_main");

//レスのテンプレートファイル
define('RESFILE', "monoev_main");

//その他のテンプレートファイル
define('OTHERFILE', "monoev_other");

//お絵かきのテンプレートファイル
define('PAINTFILE', "monoev_paint");
// define('PAINTFILE', "chickenpaintpaint");

//カタログのテンプレートファイル
define('CATALOGFILE', "monoev_catalog");
